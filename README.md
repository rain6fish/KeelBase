...
| [`docs/manual/release-gate.md`](docs/manual/release-gate.md) | Maintainers | v1.0 Release Gate — Build / Run / Trust / Private / External checklist with commands & current status (Phase 4) |
