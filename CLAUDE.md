...
# 独立治理控制平面（D-2，关键能力 2.2）：治理台独立服务 + 业务系统接入
...
# 治理 sidecar（S-1/S-2，关键能力 2.0 零代码接入）：AI 网关审计代理 + 工具门控（业务系统 LLM base URL → http://sidecar:3200/v1）
...
| `npm run start:governance` | 启动独立治理控制平面（关键能力 2.2，连独立治理库，端口 GOVERNANCE_PORT 默认 3100） |
