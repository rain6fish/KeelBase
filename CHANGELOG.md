...
- **Integrator Kit (internal-roadmap §internal.7)**: overview + capability matrix + Java compensation endpoint reference (Spring Boot, delegation JWT verify) + Governance & Deployment Guide + Reference Project manual (legacy Java CRM → AI CRM, 8 steps) + docs index
