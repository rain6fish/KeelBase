...
const workspaceNavGroups = computed(() => [
  ...
  },
  {
    ...
    items: [
      { name: 'workbench-events', to: '/workbench/events', icon: 'mdi-calendar-blank-outline', label: t('workbenchMyEvents'), module: 'events' },
      { name: 'workbench-todos', to: '/workbench/todos', icon: 'mdi-checkbox-marked-circle-outline', label: t('workbenchMyTodos'), module: 'todos' },
...
const consoleNavGroups = computed(() => [
  ...
  },
  {
    ...
    items: [
      { name: 'guard-overview', to: '/guard-overview', icon: 'mdi-shield-home-outline', label: t('navGuardOverview') },
      { name: 'risk', to: '/risk', icon: 'mdi-shield-alert-outline', label: t('navRisk') },
      ...
      { name: 'security-showcase', to: '/security-showcase', icon: 'mdi-shield-star-outline', label: t('navSecurityShowcase') },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'permissions', to: '/permissions', icon: 'mdi-shield-account-outline', label: t('navPermissions') },
