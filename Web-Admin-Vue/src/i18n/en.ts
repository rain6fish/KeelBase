...
const en: ZhDict = {
  ...
  // NC-3 first-run readiness checklist
  readinessTitle: 'First-run readiness',
  readinessCoreReady: 'Core ready',
  readinessCorePending: 'Action needed',
  readinessOk: 'Ready',
  readinessTodo: 'Action needed',
  readinessRuntime: 'Runtime',
  readinessDb: 'Database',
  readinessAi: 'AI model',
  readinessGovernance: 'Governance',
  readinessDemo: 'Demo data',
  search: 'Search',
  reset: 'Reset',
  refresh: 'Refresh',
  filter: 'Filter',
  ...
  navAiEval: 'AI Eval',
  navAiBehavior: 'Behavior Alerts',
  aiBehaviorTitle: 'AI Behavior Alerts',
  aiBehaviorDesc: 'Rule-based observation of AI behavior: alert when the pattern drifts past a threshold even though it was permitted. Observation only — nothing is blocked.',
  aiBehaviorSection: 'Alerts',
  aiBehaviorTotal: '{n}',
  aiBehaviorScopeOpen: 'Open',
  aiBehaviorScopeAll: 'All',
  aiBehaviorLoading: 'Loading…',
  aiBehaviorEmpty: 'No behavior alerts',
  aiBehaviorCritical: 'Critical',
  aiBehaviorWarning: 'Warning',
  aiBehaviorHandled: 'Handled',
  aiBehaviorSubject: 'Subject: {kind} {id}',
  aiBehaviorSubjectConversation: 'conversation',
  aiBehaviorSubjectUser: 'user',
  aiBehaviorEvidence: 'Basis',
  aiBehaviorWindow: 'window {n} min',
  aiBehaviorSamples: 'sample rows {ids}',
  aiBehaviorAcknowledge: 'Mark handled',
  aiBehaviorAckDone: 'Marked as handled',
  aiBehaviorAckFailed: 'Could not mark — it may already be handled',
  aiBehaviorLoadFailed: 'Failed to load',
  ...
  journeyStepAsk: '① Ask — AI reads real business data',
  journeyStepAct: '② Act — AI proposes a write',
  journeyStepDeny: '③ Unauthorized access — denied',
  journeyStepBlock: '④ High-risk action — blocked',
  journeySkip: 'Skip animation',
  journeyDone: 'Journey complete — every decision opens a trace and its evidence.',
  journeyReplay: 'Replay',
  createGuideTitle: 'From watch to do: real approve → land → revoke → evidence (30 min)',
  ...
  capRiskPolicy: 'Risk policy (blocked)',
  capHumanApproval: 'Human approval',
  sandboxCleanup: 'Clean demo data',
  ...
  // Trust Sandbox (§internal.15 visualization P0, workbench — "why it's safe" in 60s)
  ...
  // AI Action Center (§internal.17 / docs/ai-action-center.spec.md, business-user Trust surface)
  ...
  // GA pending confirmations (decide without leaving the conversation behind)
  aiCenterConfirmTitle: 'Waiting on me',
  aiCenterConfirmPending: '{n} pending',
  aiCenterConfirmImpact: '{n} action(s) will run',
  aiCenterConfirmExpires: 'until {at}',
  aiCenterConfirmApprove: 'Approve',
  aiCenterConfirmDecline: 'Decline',
  aiCenterConfirmApproved: 'Approved — the action has run',
  aiCenterConfirmDeclined: 'Declined — nothing was run',
  aiCenterConfirmFailed: 'Could not decide — it may already be handled or expired',
  aiCenterConfirmRunHint: 'Batch authorization — handle it in the conversation',
  aiCenterConfirmApprovalHint: 'Waiting for an approver',
  aiCenterLoading: 'Loading…',
  statusExecuted: 'Executed',
  statusRevoked: 'Revoked',
  // KB-6: 4-state revoke status (governed_external after revoke = compensation requested / result unknown; never shown as "Revoked")
  statusRevokingExternal: 'External revoke pending',
  statusRevokeFailed: 'Revoke failed',
  revokingExternalHint: 'Compensation requested — result is authoritative at the target system',
  revokeClassNone: 'Not revocable',
  revokeClassLocal: 'Revocable (local)',
  revokeClassGoverned: 'Revocable (external compensation)',
  revokeClassTransactional: 'Revocable (transactional rollback)',
  ...
  aiCenterConvRevoke: 'Revoke this conversation’s writes',
  aiCenterConvRevokeTitle: 'Revoke conversation writes',
  ...
  // §internal.16 A-1 business action ledger
  decisionEvidence: 'Decision evidence',
  // §internal.16 A-4 Audit Interpreter
  ...
  errorCount: 'Errors {n}',
  // §internal.16 A-5 cross-system identity chain
  ...
  // §internal.16 A-5 authorization chain
  authChain: 'Authorization Chain',
  // §internal.16 A-5 authorization chain graph
  ...
  exportEvidenceRoot: 'Export evidence root',
  evidenceRootExported: 'Exported evidence root (keelbase-audit-evidence/3). Verify offline: node scripts/verify-evidence.mjs <file> --key <AUDIT_HMAC_KEY>',
  evidenceRootExportFailed: 'Failed to export evidence root',
  ...
  // P2 execution axis: approved is not the same as executed. Rows that failed or never ran say so,
  // and can be retried.
  aiApprovalsExecution: 'Execution',
  aiApprovalsExecutionSucceeded: 'Executed',
  aiApprovalsExecutionFailed: 'Not completed',
  aiApprovalsExecutionRunning: 'Running',
  aiApprovalsExecutionNotStarted: 'Not run',
  aiApprovalsRetry: 'Retry',
  aiApprovalsRetried: 'Retried',
  ...
  policyHistoryHint: 'Snapshot per save — which rule version was in force',
  policyAppliedAt: 'Applied at',
  policyRevision: 'Revision',
  viewSnapshot: 'View snapshot',
  snapshotOf: 'Snapshot of revision {revision}',
  policyHistoryEmpty: 'No policy history yet (appears after the first save)',
  policyHistoryFailed: 'Failed to load policy history',
  resetPolicy: 'Reset',
  ...
  projects: 'Projects',
  tasks: 'Tasks',
  trashTypeContract: 'Contract',
  trashTypeNote: 'Note',
  trashTypeBook: 'Book',
  trashTypePost: 'Post',
  trashTypeSupplier: 'Supplier',
  trashTypeTag: 'Tag',
  trashTypeCrmCustomer: 'Customer',
  trashTypeCrmTask: 'CRM task',
  trashTypeApprovalRequest: 'Approval request',
  trashTypeOrganization: 'Organization',
  trashTypeDepartment: 'Department',
  trashTypeFlowInstance: 'Flow instance',
  sessions: 'Sessions',
  ...
  userCol: 'User',
  guestCol: 'Guest',
  convDrillTitle: 'Conversation drill-down',
  convOwner: 'Owner',
  convMsgCount: 'Messages',
  convProvider: 'Model',
  convBodyHint: 'Reference-first: the body is not prefetched. Load it explicitly when needed.',
  convShowBody: 'Show body',
  convLoadFailed: 'Failed to load the conversation',
  methodCol: 'Method',
  ...
  feature: {
    ...
    'authz.allow': 'Authorization · Allowed (why)',
    'authz.deny': 'Authorization · Denied (failed check)',
    'authz.unknown': 'Authorization · Basis not recorded',
    'authz.replay.consistent': 'Authz replay · Consistent',
    'authz.replay.drift': 'Authz replay · Drift detected',
    'authz.replay.unavailable': 'Authz replay · Unavailable',
