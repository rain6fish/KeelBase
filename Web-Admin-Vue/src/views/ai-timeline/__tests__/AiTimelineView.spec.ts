...
describe('AiTimelineView', () => {
  ...
  it('渲染会话时间线（工具调用 + 副作用 revoke 按钮）', async () => {
    ...
    effectsMock.mockResolvedValue({
      ...
      limit: 100,
      items: [
        { id: 3, toolName: 'create_event', conversationId: 'conv-1234567890123', resultType: 'event', resultId: 50, argsHash: 'h', createdAt: '2026-08-21T10:00:30Z', targetExists: true, targetSoftDeleted: false, targetTitle: '周会', status: 'executed', revokeClass: 'local_compensate', revocable: true },
      ],
    })
