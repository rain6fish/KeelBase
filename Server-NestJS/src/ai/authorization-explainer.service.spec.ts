...
/** §internal.17③ Policy Evidence：getAuthorizationReasons 单次取策略 → 决策输入 checks + 决策时策略内容指纹 revision 同源 */
describe('AuthorizationExplainerService (§internal.17③ Policy Evidence)', () => {
