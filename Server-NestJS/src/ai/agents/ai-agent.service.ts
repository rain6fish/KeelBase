...
/**
 * D5 Agent Registry（internal-roadmap §internal.10）：已注册 Agent 清单（企业可信的可见呈现）。
...
export class AiAgentService {
  ...
  /** §internal.16 A-5 跨系统身份链：audit agentId（= headless key 名 / AiAgent.name 唯一键）→ Agent 名称/信任级/用途 */
