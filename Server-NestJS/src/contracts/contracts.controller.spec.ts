...
describe('ContractsController', () => {
  ...
  let service: jest.Mocked<
    Pick<ContractsService, 'create' | 'findAll' | 'findAllForAdmin' | 'update' | 'remove' | 'removeAsAdmin'>
  >;
  ...
  beforeEach(() => {
    ...
    controller = new ContractsController(service as unknown as ContractsService);
  });
