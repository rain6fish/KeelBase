...
async function main() {
  ...
  writeFileSync(resolve(__dirname, `../docs/benchmark/multisystem-${timestamp}.json`), JSON.stringify(report, null, 2));
  ...
  console.log(`报告：docs/benchmark/multisystem-${timestamp}.json`);
  process.exit(0);
}
