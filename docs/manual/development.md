...
The full roadmap is no longer part of this public repository (2026-08-13). When a plan is reviewed/completed, append any not-done / "later" items to the internal roadmap; append completed items to the archive table with commit hash.
