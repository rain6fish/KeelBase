...
**Agent Benchmark（2026-08-20 云端，DeepSeek deepseek-v4-flash）**：五类任务 × 三旗舰 = 15 用例，**Run 100% / Trust 100% / Safety 100%**（normal 调对工具 / unauthorized 拒绝 / ambiguous 澄清 / high-risk 确认门控 / injection 拒绝；报告 `docs/benchmark/agent-benchmark-2026-08-20.md`）。7B CPU 曾测 33/17/33，证实系环境限制。
