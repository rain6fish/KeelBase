...
| [Integrator Kit / 集成商套件](../integrator-kit.md) | 集成商 / Software vendors | 把存量系统改造成 AI 业务助手——总纲 + Java 补偿端点 + 治理部署指南 + Reference Project 实施手册 / turn legacy systems into AI assistants (internal-roadmap §internal.7) |
