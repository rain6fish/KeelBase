...
const SLIDES = {
  ...
  5: { kicker: '', html: '<div class="brand">KeelBase</div><div class="brand-sub">Business-safe AI Runtime</div>', cls: '' },
  6: { kicker: 'Positioning', html: '<div class="line"><strong>AI Agents</strong></div><div class="line">MCP / OpenAPI / Tools</div><div class="line arrow">↓</div><div class="line"><strong>KeelBase Governance Layer</strong></div><div class="line arrow">↓</div><div class="line">CRM · ERP · OA · MES</div>', cls: 'sub' },
  7: { kicker: 'Governance Layer', html: '<div class="row"><span class="chip">Identity</span><span class="chip">Policy</span><span class="chip">Permission</span><span class="chip">Confirmation</span><span class="chip">Audit</span><span class="chip">Revoke</span></div>', cls: '' },
  ...
  13: { kicker: 'Live · Demo 2', html: 'Create Follow-up Task<br>Customer: HanYu Manufacturing · Owner: Alex<br>Impact preview: affected actions + revocation class<br>[ Reject ] [ Approve ]', cls: 'sub' },
  ...
  19: { kicker: 'Live · Demo 5', html: 'One action, several tables<br>Project + 3 tasks · a single write group<br>[ Reject ] [ Approve ]', cls: 'sub' },
  20: { kicker: 'Live · Demo 5', html: '<span class="ok">✓ Side effects revoked — the whole write group, cascaded</span>', cls: 'sub' },
  21: { kicker: 'Live · Demo 5', html: 'Read → Decide → Confirm → Act → Audit → Revoke', cls: 'sub' },
  22: { kicker: 'Governance Layer', html: '<div class="line"><strong>Any AI Agent</strong></div><div class="line arrow">↓ Tool / MCP / API</div><div class="line"><strong>KeelBase Governance Layer</strong></div><div class="line" style="font-size:18px">Identity · Policy · Authorization · Human Approval · Side-effect · Audit · Revoke · Evaluation</div><div class="line arrow">↓</div><div class="line">Any Business System</div>', cls: 'sub' },
  23: { kicker: 'Brand', html: '<div class="big" style="font-size:42px">Not another Agent Framework.</div><div class="sub" style="margin-top:16px;color:#d97706">A Business-safe AI Runtime.</div>', cls: '' },
  ...
  26: { kicker: 'Live · Adversarial Sandbox', html: 'Running a deterministic attack scenario —<br>outcome + decision trace, no LLM needed', cls: 'sub' },
  ...
  28: { kicker: 'Build', html: 'Business Spec → Module Protocol<br><span class="sub">one business request, mapped deterministically</span>', cls: 'sub' },
  29: { kicker: 'Build', html: '<code style="font-size:26px;background:rgba(15,23,42,0.06);padding:12px 28px;border-radius:10px;color:#1d4ed8">node scripts/keelbase-init.mjs --spec specs/invoices.json</code>', cls: '' },
  ...
  32: { kicker: 'Existing System', html: '<div class="line">Existing CRM / ERP / 10-year-old Java System / Existing Database</div><div class="line arrow">↓ Bridge</div><div class="line">Application Protocol</div><div class="line arrow">↓ KeelBase Governance Layer</div><div class="line arrow">↓ AI Agent</div>', cls: 'sub' },
  33: { kicker: 'Existing System', html: '<div class="big" style="font-size:42px">Legacy system, new AI capability.</div>', cls: '' },
  34: { kicker: 'Private Deploy', html: '<div class="line">Cloud LLM <strong>OR</strong> Local Model / Ollama</div><div class="line arrow">→ Local Embedding</div><div class="line arrow">→ Local RAG</div><div class="line arrow">→ Business-safe Agent</div><div class="line arrow">→ Local Audit</div>', cls: 'sub' },
  ...
  36: { kicker: 'Evidence', html: 'One action → a self-contained HTML report<br><span class="sub">Auditors verify it offline, without installing KeelBase</span>', cls: 'sub' },
  37: { kicker: 'First Run', html: 'Readiness: runtime · db · ai · governance · demo<br><span class="sub">every dimension comes with its own next step</span>', cls: 'sub' },
  38: { kicker: '', html: '', cls: '' },
  39: { kicker: '', html: '<div class="brand">KeelBase</div><div class="brand-sub" style="font-size:22px">Build → Run → Trust → Private Deploy</div><div class="sub" style="font-size:20px;margin-top:18px">Business-safe AI Applications</div><div class="sub" style="font-size:20px;margin-top:8px">AI can act — but only within explicit business boundaries.</div><div class="footer">Open Source · Business-safe AI Runtime<br>github.com/rain6fish/KeelBase</div>', cls: '' },
};
