...
const SLIDES = {
  ...
  6: { kicker: 'Positioning', html: '<div class="line"><strong>AI Agents</strong></div><div class="line">MCP / OpenAPI / Tools</div><div class="line arrow">↓</div><div class="line"><strong>KeelBase Trust Layer</strong></div><div class="line arrow">↓</div><div class="line">CRM · ERP · OA · MES</div>', cls: 'sub' },
  ...
  22: { kicker: 'Trust Runtime', html: '<div class="line"><strong>Any AI Agent</strong></div><div class="line arrow">↓ Tool / MCP / API</div><div class="line"><strong>KeelBase Trust Layer</strong></div><div class="line" style="font-size:18px">Identity · Policy · Authorization · Human Approval · Side-effect · Audit · Revoke · Evaluation</div><div class="line arrow">↓</div><div class="line">Any Business System</div>', cls: 'sub' },
