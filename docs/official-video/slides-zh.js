...
const SLIDES = {
  ...
  6: { kicker: '定位', html: '<div class="line"><strong>AI 代理</strong></div><div class="line">MCP / OpenAPI / 工具</div><div class="line arrow">↓</div><div class="line"><strong>KeelBase 信任层</strong></div><div class="line arrow">↓</div><div class="line">CRM · ERP · OA · MES</div>', cls: 'sub' },
  ...
  22: { kicker: '信任运行时', html: '<div class="line"><strong>任意 AI 代理</strong></div><div class="line arrow">↓ 工具 / MCP / API</div><div class="line"><strong>KeelBase 信任层</strong></div><div class="line" style="font-size:18px">身份 · 策略 · 授权 · 人工批准 · 副作用 · 审计 · 撤销 · 评测</div><div class="line arrow">↓</div><div class="line">任意业务系统</div>', cls: 'sub' },
